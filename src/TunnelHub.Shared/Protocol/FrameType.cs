...
/// <summary>
/// Frame opcodes for the TunnelHub multiplexing protocol.
/// This protocol is an original design for TunnelHub (clean-room — not derived
/// from ngrok, FRP, or any other tunneler). Each WebSocket binary message
/// carries exactly one frame: a 5-byte header (1 byte type + 4 byte big-endian
/// request id) followed by an opaque payload.
/// </summary>
